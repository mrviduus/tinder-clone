        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Photo_SizeBytes", "\"SizeBytes\" <= 5242880");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SearchGender = table.Column<int>(type: "integer", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImagePhotoId = table.Column<Guid>(type: "uuid", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_messages_photos_ImagePhotoId",
                        column: x => x.ImagePhotoId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_blocks_BlockerId_TargetId",
                table: "blocks",
                columns: new[] { "BlockerId", "TargetId" },
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_blocks_TargetId",
                table: "blocks",
                column: "TargetId");
